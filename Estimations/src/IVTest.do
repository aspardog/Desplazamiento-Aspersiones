 ...
 ivreg2 desplazamiento night_lights rainfall ruv_homicidio_pop ruv_combates_pop ruv_abandono_despojo_pop windiv10rmbos cnmh_minas_pop cnmh_desaparicion_pop vegetation (spraying_norm = windspeedrmbos) i.codmpio i.date, robust cluster(codmpio)
  weakivtest, level(0.1)
