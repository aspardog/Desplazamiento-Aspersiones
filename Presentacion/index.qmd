...
- **El mecanismo que concatena los anteriores es la reiteración en la aplicación del programa.**
    ...
    - Después de la septima reiteración del programa, los efectos de las aspersiones sobre el desplazamiento son mayores.
...
- Permite entender otras consecuencias de la expocisión a economías cocaleras como lo es el desplazamiento forzado de las personas que se encuentran alrededor de estas. 
