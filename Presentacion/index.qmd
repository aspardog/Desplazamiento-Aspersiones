...
-   **El Programa de Erradicación de Cultivos Ilicitos con Glifosato (PECIG)**: el programa principal del Plan Colombia.
...
1.  La condición de esperar cuatro meses para volver a asperjar no siempre se cumplia. Como es el efecto cuando se agregan los meses donde se asperjó consecutivamente.

-  Ante un aumento de un punto porcentual en la intesidad de aspersión implica un aumento de **2.65 puntos porcentuales** en la tasa de desplazamiento agregada en el tiempo.

2.  Una buena prueba de robustez es cubrir todo el periodo del PECIG, es decir desde el 2001 al 2014.

-   El coeficiente cambia a 4,21 puntos porcentuales y se mantiene su nivel se significancia.
