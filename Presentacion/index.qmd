...
1.  La condición de esperar cuatro meses para volver a asperjar no siempre se cumplia. ¿Cúal es el efecto cuando se agregan los meses donde se asperjó consecutivamente?.
...
3.  No es necesario incluir los choques de viento como control, no aporta y puede ir en contravía con la restricción de exclusión.
